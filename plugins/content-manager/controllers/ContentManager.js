...
module.exports = {
  ...
  create: async ctx => {
    ...
    try {
      ...
      if(ctx.request.body.fields.Date){                 
 ctx.request.body.fields.Date=moment.utc(ctx.request.body.fields.Date);
      }
      if (ctx.request.body.fields.ToDate) {
        ctx.request.body.fields.ToDate = moment.utc(ctx.request.body.fields.ToDate);
      }
      if (ctx.request.body.fields.FromDate) {
        ctx.request.body.fields.FromDate = moment.utc(ctx.request.body.fields.FromDate);
      }
