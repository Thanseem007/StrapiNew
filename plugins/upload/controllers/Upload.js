'use strict';
const cdnUrl="http://static.cdn.pitsolutions.com/StrapiMedia";
...
module.exports = {
  upload: async (ctx) => {
    ...
    const uploadedFiles = await strapi.plugins.upload.services.upload.uploadCDN(enhancedFiles,config);
